...
export const SpecialLeaveGroupFindManyArgsSchema: z.ZodType<Prisma.SpecialLeaveGroupFindManyArgs> = z.object({
...
export default SpecialLeaveGroupFindManyArgsSchema;
