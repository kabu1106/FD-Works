...
export const IncidentFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.IncidentFindUniqueOrThrowArgs> = z.object({
  select: IncidentSelectSchema.optional(),
  include: z.lazy(() => IncidentIncludeSchema).optional(),
  where: IncidentWhereUniqueInputSchema, 
}).strict();

export default IncidentFindUniqueOrThrowArgsSchema;
