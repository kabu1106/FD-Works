...
export const SpecialLeaveAssignmentFindManyArgsSchema: z.ZodType<Prisma.SpecialLeaveAssignmentFindManyArgs> = z.object({
...
export default SpecialLeaveAssignmentFindManyArgsSchema;
