...
export const StaffCreateWithoutDutyDayTypesInputSchema: z.ZodType<Prisma.StaffCreateWithoutDutyDayTypesInput> = z.strictObject({
  staffNo: z.string(),
  name: z.string(),
...
export default StaffCreateWithoutDutyDayTypesInputSchema;
