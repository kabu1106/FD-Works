...
import { IncidentCreateInputSchema } from '../inputTypeSchemas/IncidentCreateInputSchema'
import { IncidentUncheckedCreateInputSchema } from '../inputTypeSchemas/IncidentUncheckedCreateInputSchema'
import { IncidentUpdateInputSchema } from '../inputTypeSchemas/IncidentUpdateInputSchema'
import { IncidentUncheckedUpdateInputSchema } from '../inputTypeSchemas/IncidentUncheckedUpdateInputSchema'
...
export const IncidentUpsertArgsSchema: z.ZodType<Prisma.IncidentUpsertArgs> = z.object({
  select: IncidentSelectSchema.optional(),
  include: z.lazy(() => IncidentIncludeSchema).optional(),
  where: IncidentWhereUniqueInputSchema, 
  create: z.union([ IncidentCreateInputSchema, IncidentUncheckedCreateInputSchema ]),
  update: z.union([ IncidentUpdateInputSchema, IncidentUncheckedUpdateInputSchema ]),
}).strict();

export default IncidentUpsertArgsSchema;
