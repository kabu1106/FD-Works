...
export const DepartmentCreateWithoutTeamsInputSchema: z.ZodType<Prisma.DepartmentCreateWithoutTeamsInput> = z.strictObject({
  code: z.string(),
  name: z.string(),
...
export default DepartmentCreateWithoutTeamsInputSchema;
