...
export const SpecialLeaveTypeFindManyArgsSchema: z.ZodType<Prisma.SpecialLeaveTypeFindManyArgs> = z.object({
...
export default SpecialLeaveTypeFindManyArgsSchema;
