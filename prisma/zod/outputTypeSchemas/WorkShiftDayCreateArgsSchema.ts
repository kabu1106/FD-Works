...
export const WorkShiftDayCreateArgsSchema: z.ZodType<Prisma.WorkShiftDayCreateArgs> = z.object({
  select: WorkShiftDaySelectSchema.optional(),
  include: z.lazy(() => WorkShiftDayIncludeSchema).optional(),
  data: z.union([ WorkShiftDayCreateInputSchema, WorkShiftDayUncheckedCreateInputSchema ]),
}).strict();

export default WorkShiftDayCreateArgsSchema;
