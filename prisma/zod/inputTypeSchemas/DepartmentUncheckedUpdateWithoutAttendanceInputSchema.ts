...
import { TeamUncheckedUpdateManyWithoutDepartmentsNestedInputSchema } from './TeamUncheckedUpdateManyWithoutDepartmentsNestedInputSchema';
...
export const DepartmentUncheckedUpdateWithoutAttendanceInputSchema: z.ZodType<Prisma.DepartmentUncheckedUpdateWithoutAttendanceInput> = z.strictObject({
  ...
  teams: z.lazy(() => TeamUncheckedUpdateManyWithoutDepartmentsNestedInputSchema).optional(),
  vehicle: z.lazy(() => VehicleUncheckedUpdateManyWithoutDepartmentNestedInputSchema).optional(),
});

export default DepartmentUncheckedUpdateWithoutAttendanceInputSchema;
