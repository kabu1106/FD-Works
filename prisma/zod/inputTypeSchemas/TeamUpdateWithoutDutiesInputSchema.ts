...
export const TeamUpdateWithoutDutiesInputSchema: z.ZodType<Prisma.TeamUpdateWithoutDutiesInput> = z.strictObject({
...
export default TeamUpdateWithoutDutiesInputSchema;
