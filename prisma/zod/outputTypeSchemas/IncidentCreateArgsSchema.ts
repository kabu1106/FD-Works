...
export const IncidentCreateArgsSchema: z.ZodType<Prisma.IncidentCreateArgs> = z.object({
  select: IncidentSelectSchema.optional(),
  include: z.lazy(() => IncidentIncludeSchema).optional(),
  data: z.union([ IncidentCreateInputSchema, IncidentUncheckedCreateInputSchema ]),
}).strict();

export default IncidentCreateArgsSchema;
