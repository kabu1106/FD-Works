...
export const DispatchedVehicleCreateArgsSchema: z.ZodType<Prisma.DispatchedVehicleCreateArgs> = z.object({
  select: DispatchedVehicleSelectSchema.optional(),
  include: z.lazy(() => DispatchedVehicleIncludeSchema).optional(),
  data: z.union([ DispatchedVehicleCreateInputSchema, DispatchedVehicleUncheckedCreateInputSchema ]),
}).strict();

export default DispatchedVehicleCreateArgsSchema;
