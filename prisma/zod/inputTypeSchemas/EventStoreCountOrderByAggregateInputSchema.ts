...
export const EventStoreCountOrderByAggregateInputSchema: z.ZodType<Prisma.EventStoreCountOrderByAggregateInput> = z.strictObject({
...
export default EventStoreCountOrderByAggregateInputSchema;
