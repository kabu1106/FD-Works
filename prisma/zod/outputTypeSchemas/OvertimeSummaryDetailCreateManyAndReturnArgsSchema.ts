...
export const OvertimeSummaryDetailCreateManyAndReturnArgsSchema: z.ZodType<Prisma.OvertimeSummaryDetailCreateManyAndReturnArgs> = z.object({
  data: z.union([ OvertimeSummaryDetailCreateManyInputSchema, OvertimeSummaryDetailCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export default OvertimeSummaryDetailCreateManyAndReturnArgsSchema;
