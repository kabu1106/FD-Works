...
export const OvertimeSummaryCreateArgsSchema: z.ZodType<Prisma.OvertimeSummaryCreateArgs> = z.object({
  select: OvertimeSummarySelectSchema.optional(),
  include: z.lazy(() => OvertimeSummaryIncludeSchema).optional(),
  data: z.union([ OvertimeSummaryCreateInputSchema, OvertimeSummaryUncheckedCreateInputSchema ]),
}).strict();

export default OvertimeSummaryCreateArgsSchema;
