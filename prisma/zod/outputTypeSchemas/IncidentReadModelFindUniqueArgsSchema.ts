...
export const IncidentReadModelFindUniqueArgsSchema: z.ZodType<Prisma.IncidentReadModelFindUniqueArgs> = z.object({
...
export default IncidentReadModelFindUniqueArgsSchema;
