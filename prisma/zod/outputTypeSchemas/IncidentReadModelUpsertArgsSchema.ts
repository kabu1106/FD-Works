...
export const IncidentReadModelUpsertArgsSchema: z.ZodType<Prisma.IncidentReadModelUpsertArgs> = z.object({
  ...
  create: z.union([ IncidentReadModelCreateInputSchema, IncidentReadModelUncheckedCreateInputSchema ]),
  update: z.union([ IncidentReadModelUpdateInputSchema, IncidentReadModelUncheckedUpdateInputSchema ]),
}).strict();

export default IncidentReadModelUpsertArgsSchema;
