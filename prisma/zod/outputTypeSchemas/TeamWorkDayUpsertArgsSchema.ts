...
export const TeamWorkDayUpsertArgsSchema: z.ZodType<Prisma.TeamWorkDayUpsertArgs> = z.object({
  ...
  create: z.union([ TeamWorkDayCreateInputSchema, TeamWorkDayUncheckedCreateInputSchema ]),
  update: z.union([ TeamWorkDayUpdateInputSchema, TeamWorkDayUncheckedUpdateInputSchema ]),
}).strict();

export default TeamWorkDayUpsertArgsSchema;
