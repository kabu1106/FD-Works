...
export const OvertimeSlotResolvedFindUniqueArgsSchema: z.ZodType<Prisma.OvertimeSlotResolvedFindUniqueArgs> = z.object({
  select: OvertimeSlotResolvedSelectSchema.optional(),
  where: OvertimeSlotResolvedWhereUniqueInputSchema, 
}).strict();

export default OvertimeSlotResolvedFindUniqueArgsSchema;
