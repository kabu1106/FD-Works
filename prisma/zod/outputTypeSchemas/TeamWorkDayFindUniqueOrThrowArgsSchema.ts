...
export const TeamWorkDayFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.TeamWorkDayFindUniqueOrThrowArgs> = z.object({
...
export default TeamWorkDayFindUniqueOrThrowArgsSchema;
