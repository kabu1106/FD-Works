...
export const SpecialLeaveTypeFindFirstOrThrowArgsSchema: z.ZodType<Prisma.SpecialLeaveTypeFindFirstOrThrowArgs> = z.object({
...
export default SpecialLeaveTypeFindFirstOrThrowArgsSchema;
