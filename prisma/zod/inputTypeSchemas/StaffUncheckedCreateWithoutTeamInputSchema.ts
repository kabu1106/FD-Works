...
export const StaffUncheckedCreateWithoutTeamInputSchema: z.ZodType<Prisma.StaffUncheckedCreateWithoutTeamInput> = z.strictObject({
...
export default StaffUncheckedCreateWithoutTeamInputSchema;
