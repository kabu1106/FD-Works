...
export const IncidentAllowanceSummaryUpdateArgsSchema: z.ZodType<Prisma.IncidentAllowanceSummaryUpdateArgs> = z.object({
  select: IncidentAllowanceSummarySelectSchema.optional(),
  include: z.lazy(() => IncidentAllowanceSummaryIncludeSchema).optional(),
  data: z.union([ IncidentAllowanceSummaryUpdateInputSchema, IncidentAllowanceSummaryUncheckedUpdateInputSchema ]),
  where: IncidentAllowanceSummaryWhereUniqueInputSchema, 
}).strict();

export default IncidentAllowanceSummaryUpdateArgsSchema;
