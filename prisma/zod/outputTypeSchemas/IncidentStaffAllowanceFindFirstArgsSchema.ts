...
export const IncidentStaffAllowanceFindFirstArgsSchema: z.ZodType<Prisma.IncidentStaffAllowanceFindFirstArgs> = z.object({
...
export default IncidentStaffAllowanceFindFirstArgsSchema;
