...
export const SpecialLeaveAssignmentFindFirstOrThrowArgsSchema: z.ZodType<Prisma.SpecialLeaveAssignmentFindFirstOrThrowArgs> = z.object({
...
export default SpecialLeaveAssignmentFindFirstOrThrowArgsSchema;
