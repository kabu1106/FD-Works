...
export const IncidentReadModelFindFirstArgsSchema: z.ZodType<Prisma.IncidentReadModelFindFirstArgs> = z.object({
...
export default IncidentReadModelFindFirstArgsSchema;
