...
export const IncidentVehicleCreateArgsSchema: z.ZodType<Prisma.IncidentVehicleCreateArgs> = z.object({
  select: IncidentVehicleSelectSchema.optional(),
  include: z.lazy(() => IncidentVehicleIncludeSchema).optional(),
  data: z.union([ IncidentVehicleCreateInputSchema, IncidentVehicleUncheckedCreateInputSchema ]),
}).strict();

export default IncidentVehicleCreateArgsSchema;
