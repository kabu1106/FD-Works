...
export const OvertimeSummaryUpdateArgsSchema: z.ZodType<Prisma.OvertimeSummaryUpdateArgs> = z.object({
  select: OvertimeSummarySelectSchema.optional(),
  include: z.lazy(() => OvertimeSummaryIncludeSchema).optional(),
  data: z.union([ OvertimeSummaryUpdateInputSchema, OvertimeSummaryUncheckedUpdateInputSchema ]),
  where: OvertimeSummaryWhereUniqueInputSchema, 
}).strict();

export default OvertimeSummaryUpdateArgsSchema;
