...
export const DutyFindFirstOrThrowArgsSchema: z.ZodType<Prisma.DutyFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ DutyScalarFieldEnumSchema, DutyScalarFieldEnumSchema.array() ]).optional(),
}).strict();

export default DutyFindFirstOrThrowArgsSchema;
