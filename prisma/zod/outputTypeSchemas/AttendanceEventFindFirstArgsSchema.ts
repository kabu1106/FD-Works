...
export const AttendanceEventFindFirstArgsSchema: z.ZodType<Prisma.AttendanceEventFindFirstArgs> = z.object({
...
export default AttendanceEventFindFirstArgsSchema;
