...
export const IncidentReadModelFindFirstOrThrowArgsSchema: z.ZodType<Prisma.IncidentReadModelFindFirstOrThrowArgs> = z.object({
...
export default IncidentReadModelFindFirstOrThrowArgsSchema;
