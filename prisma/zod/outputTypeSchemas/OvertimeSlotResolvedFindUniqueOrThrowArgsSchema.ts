...
export const OvertimeSlotResolvedFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.OvertimeSlotResolvedFindUniqueOrThrowArgs> = z.object({
  select: OvertimeSlotResolvedSelectSchema.optional(),
  where: OvertimeSlotResolvedWhereUniqueInputSchema, 
}).strict();

export default OvertimeSlotResolvedFindUniqueOrThrowArgsSchema;
