...
export const IncidentStaffCreateManyAndReturnArgsSchema: z.ZodType<Prisma.IncidentStaffCreateManyAndReturnArgs> = z.object({
  data: z.union([ IncidentStaffCreateManyInputSchema, IncidentStaffCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export default IncidentStaffCreateManyAndReturnArgsSchema;
