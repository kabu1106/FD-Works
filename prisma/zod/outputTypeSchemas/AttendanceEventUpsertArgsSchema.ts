...
import { AttendanceEventUpdateInputSchema } from '../inputTypeSchemas/AttendanceEventUpdateInputSchema'
import { AttendanceEventUncheckedUpdateInputSchema } from '../inputTypeSchemas/AttendanceEventUncheckedUpdateInputSchema'
...
export const AttendanceEventUpsertArgsSchema: z.ZodType<Prisma.AttendanceEventUpsertArgs> = z.object({
  ...
  create: z.union([ AttendanceEventCreateInputSchema, AttendanceEventUncheckedCreateInputSchema ]),
  update: z.union([ AttendanceEventUpdateInputSchema, AttendanceEventUncheckedUpdateInputSchema ]),
}).strict();

export default AttendanceEventUpsertArgsSchema;
