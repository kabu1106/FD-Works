...
export const WorkGroupAssignmentFindManyArgsSchema: z.ZodType<Prisma.WorkGroupAssignmentFindManyArgs> = z.object({
...
export default WorkGroupAssignmentFindManyArgsSchema;
