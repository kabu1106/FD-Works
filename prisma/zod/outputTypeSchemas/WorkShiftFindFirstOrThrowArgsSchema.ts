...
export const WorkShiftFindFirstOrThrowArgsSchema: z.ZodType<Prisma.WorkShiftFindFirstOrThrowArgs> = z.object({
...
export default WorkShiftFindFirstOrThrowArgsSchema;
