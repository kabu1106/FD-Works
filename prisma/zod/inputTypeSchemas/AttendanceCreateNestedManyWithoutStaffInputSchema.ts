...
export const AttendanceCreateNestedManyWithoutStaffInputSchema: z.ZodType<Prisma.AttendanceCreateNestedManyWithoutStaffInput> = z.strictObject({
...
export default AttendanceCreateNestedManyWithoutStaffInputSchema;
