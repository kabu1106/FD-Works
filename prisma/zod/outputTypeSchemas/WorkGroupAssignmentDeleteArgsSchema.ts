...
export const WorkGroupAssignmentDeleteArgsSchema: z.ZodType<Prisma.WorkGroupAssignmentDeleteArgs> = z.object({
...
export default WorkGroupAssignmentDeleteArgsSchema;
