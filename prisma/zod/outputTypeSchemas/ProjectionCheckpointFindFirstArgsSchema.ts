...
export const ProjectionCheckpointFindFirstArgsSchema: z.ZodType<Prisma.ProjectionCheckpointFindFirstArgs> = z.object({
...
export default ProjectionCheckpointFindFirstArgsSchema;
