...
export const IncidentVehicleFindFirstOrThrowArgsSchema: z.ZodType<Prisma.IncidentVehicleFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ IncidentVehicleScalarFieldEnumSchema, IncidentVehicleScalarFieldEnumSchema.array() ]).optional(),
}).strict();

export default IncidentVehicleFindFirstOrThrowArgsSchema;
