...
export const HospitalCreateWithoutDestinationInputSchema: z.ZodType<Prisma.HospitalCreateWithoutDestinationInput> = z.strictObject({
  code: z.string(),
  name: z.string(),
...
export default HospitalCreateWithoutDestinationInputSchema;
