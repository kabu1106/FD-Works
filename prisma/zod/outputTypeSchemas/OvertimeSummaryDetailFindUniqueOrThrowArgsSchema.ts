...
export const OvertimeSummaryDetailFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.OvertimeSummaryDetailFindUniqueOrThrowArgs> = z.object({
...
export default OvertimeSummaryDetailFindUniqueOrThrowArgsSchema;
