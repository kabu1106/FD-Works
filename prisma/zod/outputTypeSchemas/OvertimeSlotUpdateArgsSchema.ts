...
export const OvertimeSlotUpdateArgsSchema: z.ZodType<Prisma.OvertimeSlotUpdateArgs> = z.object({
  select: OvertimeSlotSelectSchema.optional(),
  include: z.lazy(() => OvertimeSlotIncludeSchema).optional(),
  data: z.union([ OvertimeSlotUpdateInputSchema, OvertimeSlotUncheckedUpdateInputSchema ]),
  where: OvertimeSlotWhereUniqueInputSchema, 
}).strict();

export default OvertimeSlotUpdateArgsSchema;
