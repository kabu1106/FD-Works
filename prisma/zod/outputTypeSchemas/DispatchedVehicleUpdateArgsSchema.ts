...
export const DispatchedVehicleUpdateArgsSchema: z.ZodType<Prisma.DispatchedVehicleUpdateArgs> = z.object({
  select: DispatchedVehicleSelectSchema.optional(),
  include: z.lazy(() => DispatchedVehicleIncludeSchema).optional(),
  data: z.union([ DispatchedVehicleUpdateInputSchema, DispatchedVehicleUncheckedUpdateInputSchema ]),
  where: DispatchedVehicleWhereUniqueInputSchema, 
}).strict();

export default DispatchedVehicleUpdateArgsSchema;
