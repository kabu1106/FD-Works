...
export const TeamWorkOverrideFindFirstArgsSchema: z.ZodType<Prisma.TeamWorkOverrideFindFirstArgs> = z.object({
...
export default TeamWorkOverrideFindFirstArgsSchema;
