...
import { AllowanceTypeCreateInputSchema } from '../inputTypeSchemas/AllowanceTypeCreateInputSchema'
import { AllowanceTypeUncheckedCreateInputSchema } from '../inputTypeSchemas/AllowanceTypeUncheckedCreateInputSchema'
import { AllowanceTypeUpdateInputSchema } from '../inputTypeSchemas/AllowanceTypeUpdateInputSchema'
import { AllowanceTypeUncheckedUpdateInputSchema } from '../inputTypeSchemas/AllowanceTypeUncheckedUpdateInputSchema'
...
export const AllowanceTypeUpsertArgsSchema: z.ZodType<Prisma.AllowanceTypeUpsertArgs> = z.object({
  ...
  create: z.union([ AllowanceTypeCreateInputSchema, AllowanceTypeUncheckedCreateInputSchema ]),
  update: z.union([ AllowanceTypeUpdateInputSchema, AllowanceTypeUncheckedUpdateInputSchema ]),
}).strict();

export default AllowanceTypeUpsertArgsSchema;
