...
export const SpecialLeaveAssignmentUpsertArgsSchema: z.ZodType<Prisma.SpecialLeaveAssignmentUpsertArgs> = z.object({
  ...
  create: z.union([ SpecialLeaveAssignmentCreateInputSchema, SpecialLeaveAssignmentUncheckedCreateInputSchema ]),
  update: z.union([ SpecialLeaveAssignmentUpdateInputSchema, SpecialLeaveAssignmentUncheckedUpdateInputSchema ]),
}).strict();

export default SpecialLeaveAssignmentUpsertArgsSchema;
