...
export const IncidentUpdateArgsSchema: z.ZodType<Prisma.IncidentUpdateArgs> = z.object({
  select: IncidentSelectSchema.optional(),
  include: z.lazy(() => IncidentIncludeSchema).optional(),
  data: z.union([ IncidentUpdateInputSchema, IncidentUncheckedUpdateInputSchema ]),
  where: IncidentWhereUniqueInputSchema, 
}).strict();

export default IncidentUpdateArgsSchema;
