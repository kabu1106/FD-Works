...
export const StaffCreateWithoutAttendanceEventsInputSchema: z.ZodType<Prisma.StaffCreateWithoutAttendanceEventsInput> = z.strictObject({
  staffNo: z.string(),
  name: z.string(),
...
export default StaffCreateWithoutAttendanceEventsInputSchema;
