...
export const IncidentVehicleFindUniqueArgsSchema: z.ZodType<Prisma.IncidentVehicleFindUniqueArgs> = z.object({
...
export default IncidentVehicleFindUniqueArgsSchema;
