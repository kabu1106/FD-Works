...
export const AllowanceTypeCreateArgsSchema: z.ZodType<Prisma.AllowanceTypeCreateArgs> = z.object({
  select: AllowanceTypeSelectSchema.optional(),
  include: z.lazy(() => AllowanceTypeIncludeSchema).optional(),
  data: z.union([ AllowanceTypeCreateInputSchema, AllowanceTypeUncheckedCreateInputSchema ]),
}).strict();

export default AllowanceTypeCreateArgsSchema;
