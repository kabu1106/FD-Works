...
export const DutyUpdateArgsSchema: z.ZodType<Prisma.DutyUpdateArgs> = z.object({
  select: DutySelectSchema.optional(),
  include: z.lazy(() => DutyIncludeSchema).optional(),
  data: z.union([ DutyUpdateInputSchema, DutyUncheckedUpdateInputSchema ]),
  where: DutyWhereUniqueInputSchema, 
}).strict();

export default DutyUpdateArgsSchema;
