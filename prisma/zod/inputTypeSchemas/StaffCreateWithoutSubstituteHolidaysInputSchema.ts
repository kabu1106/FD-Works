...
export const StaffCreateWithoutSubstituteHolidaysInputSchema: z.ZodType<Prisma.StaffCreateWithoutSubstituteHolidaysInput> = z.strictObject({
  staffNo: z.string(),
  name: z.string(),
...
export default StaffCreateWithoutSubstituteHolidaysInputSchema;
