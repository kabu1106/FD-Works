...
export const IncidentCreateNestedManyWithoutCategoryInputSchema: z.ZodType<Prisma.IncidentCreateNestedManyWithoutCategoryInput> = z.strictObject({
...
export default IncidentCreateNestedManyWithoutCategoryInputSchema;
