...
export const WorkShiftCreateArgsSchema: z.ZodType<Prisma.WorkShiftCreateArgs> = z.object({
  select: WorkShiftSelectSchema.optional(),
  include: z.lazy(() => WorkShiftIncludeSchema).optional(),
  data: z.union([ WorkShiftCreateInputSchema, WorkShiftUncheckedCreateInputSchema ]),
}).strict();

export default WorkShiftCreateArgsSchema;
