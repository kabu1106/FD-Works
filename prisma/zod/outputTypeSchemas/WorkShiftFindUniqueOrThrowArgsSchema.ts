...
export const WorkShiftFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.WorkShiftFindUniqueOrThrowArgs> = z.object({
  select: WorkShiftSelectSchema.optional(),
  include: z.lazy(() => WorkShiftIncludeSchema).optional(),
  where: WorkShiftWhereUniqueInputSchema, 
}).strict();

export default WorkShiftFindUniqueOrThrowArgsSchema;
