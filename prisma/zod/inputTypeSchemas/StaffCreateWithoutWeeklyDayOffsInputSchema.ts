...
export const StaffCreateWithoutWeeklyDayOffsInputSchema: z.ZodType<Prisma.StaffCreateWithoutWeeklyDayOffsInput> = z.strictObject({
  staffNo: z.string(),
  name: z.string(),
...
export default StaffCreateWithoutWeeklyDayOffsInputSchema;
