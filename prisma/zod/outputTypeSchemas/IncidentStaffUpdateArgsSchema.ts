...
export const IncidentStaffUpdateArgsSchema: z.ZodType<Prisma.IncidentStaffUpdateArgs> = z.object({
  select: IncidentStaffSelectSchema.optional(),
  include: z.lazy(() => IncidentStaffIncludeSchema).optional(),
  data: z.union([ IncidentStaffUpdateInputSchema, IncidentStaffUncheckedUpdateInputSchema ]),
  where: IncidentStaffWhereUniqueInputSchema, 
}).strict();

export default IncidentStaffUpdateArgsSchema;
