...
export const TeamWorkOverrideCreateManyArgsSchema: z.ZodType<Prisma.TeamWorkOverrideCreateManyArgs> = z.object({
  data: z.union([ TeamWorkOverrideCreateManyInputSchema, TeamWorkOverrideCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export default TeamWorkOverrideCreateManyArgsSchema;
