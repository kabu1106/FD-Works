...
import { DutyUpdateInputSchema } from '../inputTypeSchemas/DutyUpdateInputSchema'
import { DutyUncheckedUpdateInputSchema } from '../inputTypeSchemas/DutyUncheckedUpdateInputSchema'
...
export const DutyUpsertArgsSchema: z.ZodType<Prisma.DutyUpsertArgs> = z.object({
  select: DutySelectSchema.optional(),
  include: z.lazy(() => DutyIncludeSchema).optional(),
  where: DutyWhereUniqueInputSchema, 
  create: z.union([ DutyCreateInputSchema, DutyUncheckedCreateInputSchema ]),
  update: z.union([ DutyUpdateInputSchema, DutyUncheckedUpdateInputSchema ]),
}).strict();

export default DutyUpsertArgsSchema;
