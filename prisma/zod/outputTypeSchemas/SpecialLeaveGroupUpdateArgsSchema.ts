...
export const SpecialLeaveGroupUpdateArgsSchema: z.ZodType<Prisma.SpecialLeaveGroupUpdateArgs> = z.object({
  select: SpecialLeaveGroupSelectSchema.optional(),
  include: z.lazy(() => SpecialLeaveGroupIncludeSchema).optional(),
  data: z.union([ SpecialLeaveGroupUpdateInputSchema, SpecialLeaveGroupUncheckedUpdateInputSchema ]),
  where: SpecialLeaveGroupWhereUniqueInputSchema, 
}).strict();

export default SpecialLeaveGroupUpdateArgsSchema;
