...
export const IncidentAllowanceSummaryFindManyArgsSchema: z.ZodType<Prisma.IncidentAllowanceSummaryFindManyArgs> = z.object({
...
export default IncidentAllowanceSummaryFindManyArgsSchema;
