...
export const SpecialLeaveAssignmentFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.SpecialLeaveAssignmentFindUniqueOrThrowArgs> = z.object({
...
export default SpecialLeaveAssignmentFindUniqueOrThrowArgsSchema;
