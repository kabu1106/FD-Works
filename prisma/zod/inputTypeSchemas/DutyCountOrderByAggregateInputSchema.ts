...
export const DutyCountOrderByAggregateInputSchema: z.ZodType<Prisma.DutyCountOrderByAggregateInput> = z.strictObject({
...
export default DutyCountOrderByAggregateInputSchema;
