...
import { IncidentUpdateManyWithoutDestinationNestedInputSchema } from './IncidentUpdateManyWithoutDestinationNestedInputSchema';

export const HospitalUpdateInputSchema: z.ZodType<Prisma.HospitalUpdateInput> = z.strictObject({
  ...
  destination: z.lazy(() => IncidentUpdateManyWithoutDestinationNestedInputSchema).optional(),
});

export default HospitalUpdateInputSchema;
