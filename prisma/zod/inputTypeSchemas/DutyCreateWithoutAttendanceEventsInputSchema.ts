...
export const DutyCreateWithoutAttendanceEventsInputSchema: z.ZodType<Prisma.DutyCreateWithoutAttendanceEventsInput> = z.strictObject({
...
export default DutyCreateWithoutAttendanceEventsInputSchema;
