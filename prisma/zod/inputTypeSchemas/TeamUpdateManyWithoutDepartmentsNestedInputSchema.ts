...
export const TeamUpdateManyWithoutDepartmentsNestedInputSchema: z.ZodType<Prisma.TeamUpdateManyWithoutDepartmentsNestedInput> = z.strictObject({
...
export default TeamUpdateManyWithoutDepartmentsNestedInputSchema;
