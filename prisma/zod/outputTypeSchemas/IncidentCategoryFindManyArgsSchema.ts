...
export const IncidentCategoryFindManyArgsSchema: z.ZodType<Prisma.IncidentCategoryFindManyArgs> = z.object({
...
export default IncidentCategoryFindManyArgsSchema;
