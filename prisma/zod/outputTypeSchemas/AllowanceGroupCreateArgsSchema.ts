...
export const AllowanceGroupCreateArgsSchema: z.ZodType<Prisma.AllowanceGroupCreateArgs> = z.object({
  select: AllowanceGroupSelectSchema.optional(),
  include: z.lazy(() => AllowanceGroupIncludeSchema).optional(),
  data: z.union([ AllowanceGroupCreateInputSchema, AllowanceGroupUncheckedCreateInputSchema ]),
}).strict();

export default AllowanceGroupCreateArgsSchema;
