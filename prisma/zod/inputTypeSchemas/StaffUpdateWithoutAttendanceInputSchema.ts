...
export const StaffUpdateWithoutAttendanceInputSchema: z.ZodType<Prisma.StaffUpdateWithoutAttendanceInput> = z.strictObject({
...
export default StaffUpdateWithoutAttendanceInputSchema;
