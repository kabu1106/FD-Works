...
export const LocationCreateNestedManyWithoutParentInputSchema: z.ZodType<Prisma.LocationCreateNestedManyWithoutParentInput> = z.strictObject({
...
export default LocationCreateNestedManyWithoutParentInputSchema;
