...
export const SpecialLeaveTypeFindUniqueArgsSchema: z.ZodType<Prisma.SpecialLeaveTypeFindUniqueArgs> = z.object({
...
export default SpecialLeaveTypeFindUniqueArgsSchema;
