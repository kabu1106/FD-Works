...
export const AttendanceEventUpdateArgsSchema: z.ZodType<Prisma.AttendanceEventUpdateArgs> = z.object({
  select: AttendanceEventSelectSchema.optional(),
  include: z.lazy(() => AttendanceEventIncludeSchema).optional(),
  data: z.union([ AttendanceEventUpdateInputSchema, AttendanceEventUncheckedUpdateInputSchema ]),
  where: AttendanceEventWhereUniqueInputSchema, 
}).strict();

export default AttendanceEventUpdateArgsSchema;
