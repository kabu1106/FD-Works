...
export const StaffUncheckedCreateWithoutAttendanceInputSchema: z.ZodType<Prisma.StaffUncheckedCreateWithoutAttendanceInput> = z.strictObject({
...
export default StaffUncheckedCreateWithoutAttendanceInputSchema;
