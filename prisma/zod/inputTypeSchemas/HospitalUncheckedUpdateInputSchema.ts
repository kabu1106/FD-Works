...
import { IncidentUncheckedUpdateManyWithoutDestinationNestedInputSchema } from './IncidentUncheckedUpdateManyWithoutDestinationNestedInputSchema';

export const HospitalUncheckedUpdateInputSchema: z.ZodType<Prisma.HospitalUncheckedUpdateInput> = z.strictObject({
  ...
  destination: z.lazy(() => IncidentUncheckedUpdateManyWithoutDestinationNestedInputSchema).optional(),
});

export default HospitalUncheckedUpdateInputSchema;
