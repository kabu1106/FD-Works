...
export const TeamUncheckedCreateNestedManyWithoutWorkShiftInputSchema: z.ZodType<Prisma.TeamUncheckedCreateNestedManyWithoutWorkShiftInput> = z.strictObject({
...
export default TeamUncheckedCreateNestedManyWithoutWorkShiftInputSchema;
