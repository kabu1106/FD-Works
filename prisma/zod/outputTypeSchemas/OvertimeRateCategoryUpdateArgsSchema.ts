...
export const OvertimeRateCategoryUpdateArgsSchema: z.ZodType<Prisma.OvertimeRateCategoryUpdateArgs> = z.object({
  select: OvertimeRateCategorySelectSchema.optional(),
  include: z.lazy(() => OvertimeRateCategoryIncludeSchema).optional(),
  data: z.union([ OvertimeRateCategoryUpdateInputSchema, OvertimeRateCategoryUncheckedUpdateInputSchema ]),
  where: OvertimeRateCategoryWhereUniqueInputSchema, 
}).strict();

export default OvertimeRateCategoryUpdateArgsSchema;
