...
export const IncidentStaffAllowanceDeleteArgsSchema: z.ZodType<Prisma.IncidentStaffAllowanceDeleteArgs> = z.object({
...
export default IncidentStaffAllowanceDeleteArgsSchema;
