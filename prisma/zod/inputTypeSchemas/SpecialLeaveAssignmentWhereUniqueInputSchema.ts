...
export const SpecialLeaveAssignmentWhereUniqueInputSchema: z.ZodType<Prisma.SpecialLeaveAssignmentWhereUniqueInput> = z.object({
  id: z.string(),
})
.and(z.strictObject({
...
export default SpecialLeaveAssignmentWhereUniqueInputSchema;
