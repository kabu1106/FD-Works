...
export const IncidentCategoryFindFirstOrThrowArgsSchema: z.ZodType<Prisma.IncidentCategoryFindFirstOrThrowArgs> = z.object({
...
export default IncidentCategoryFindFirstOrThrowArgsSchema;
