...
export const IncidentStaffAllowanceFindManyArgsSchema: z.ZodType<Prisma.IncidentStaffAllowanceFindManyArgs> = z.object({
...
export default IncidentStaffAllowanceFindManyArgsSchema;
