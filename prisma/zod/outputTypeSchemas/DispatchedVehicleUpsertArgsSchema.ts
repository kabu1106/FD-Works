...
import { DispatchedVehicleCreateInputSchema } from '../inputTypeSchemas/DispatchedVehicleCreateInputSchema'
import { DispatchedVehicleUncheckedCreateInputSchema } from '../inputTypeSchemas/DispatchedVehicleUncheckedCreateInputSchema'
import { DispatchedVehicleUpdateInputSchema } from '../inputTypeSchemas/DispatchedVehicleUpdateInputSchema'
import { DispatchedVehicleUncheckedUpdateInputSchema } from '../inputTypeSchemas/DispatchedVehicleUncheckedUpdateInputSchema'
...
export const DispatchedVehicleUpsertArgsSchema: z.ZodType<Prisma.DispatchedVehicleUpsertArgs> = z.object({
  ...
  create: z.union([ DispatchedVehicleCreateInputSchema, DispatchedVehicleUncheckedCreateInputSchema ]),
  update: z.union([ DispatchedVehicleUpdateInputSchema, DispatchedVehicleUncheckedUpdateInputSchema ]),
}).strict();

export default DispatchedVehicleUpsertArgsSchema;
