...
export const IncidentCategoryFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.IncidentCategoryFindUniqueOrThrowArgs> = z.object({
...
export default IncidentCategoryFindUniqueOrThrowArgsSchema;
