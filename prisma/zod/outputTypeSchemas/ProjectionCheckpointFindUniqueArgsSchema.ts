...
export const ProjectionCheckpointFindUniqueArgsSchema: z.ZodType<Prisma.ProjectionCheckpointFindUniqueArgs> = z.object({
  select: ProjectionCheckpointSelectSchema.optional(),
  where: ProjectionCheckpointWhereUniqueInputSchema, 
}).strict();

export default ProjectionCheckpointFindUniqueArgsSchema;
