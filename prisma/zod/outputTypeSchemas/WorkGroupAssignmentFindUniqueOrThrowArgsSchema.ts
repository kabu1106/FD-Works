...
export const WorkGroupAssignmentFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.WorkGroupAssignmentFindUniqueOrThrowArgs> = z.object({
...
export default WorkGroupAssignmentFindUniqueOrThrowArgsSchema;
