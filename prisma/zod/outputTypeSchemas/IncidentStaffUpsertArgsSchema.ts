...
import { IncidentStaffUpdateInputSchema } from '../inputTypeSchemas/IncidentStaffUpdateInputSchema'
import { IncidentStaffUncheckedUpdateInputSchema } from '../inputTypeSchemas/IncidentStaffUncheckedUpdateInputSchema'
...
export const IncidentStaffUpsertArgsSchema: z.ZodType<Prisma.IncidentStaffUpsertArgs> = z.object({
  ...
  create: z.union([ IncidentStaffCreateInputSchema, IncidentStaffUncheckedCreateInputSchema ]),
  update: z.union([ IncidentStaffUpdateInputSchema, IncidentStaffUncheckedUpdateInputSchema ]),
}).strict();

export default IncidentStaffUpsertArgsSchema;
