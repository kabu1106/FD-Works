...
export const IncidentAllowanceSummaryFindFirstArgsSchema: z.ZodType<Prisma.IncidentAllowanceSummaryFindFirstArgs> = z.object({
...
export default IncidentAllowanceSummaryFindFirstArgsSchema;
