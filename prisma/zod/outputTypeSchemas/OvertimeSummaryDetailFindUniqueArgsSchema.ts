...
export const OvertimeSummaryDetailFindUniqueArgsSchema: z.ZodType<Prisma.OvertimeSummaryDetailFindUniqueArgs> = z.object({
...
export default OvertimeSummaryDetailFindUniqueArgsSchema;
