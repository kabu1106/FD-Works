...
export const DutyDayTypeUpdateArgsSchema: z.ZodType<Prisma.DutyDayTypeUpdateArgs> = z.object({
  select: DutyDayTypeSelectSchema.optional(),
  include: z.lazy(() => DutyDayTypeIncludeSchema).optional(),
  data: z.union([ DutyDayTypeUpdateInputSchema, DutyDayTypeUncheckedUpdateInputSchema ]),
  where: DutyDayTypeWhereUniqueInputSchema, 
}).strict();

export default DutyDayTypeUpdateArgsSchema;
