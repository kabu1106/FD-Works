...
export const WorkGroupFindFirstOrThrowArgsSchema: z.ZodType<Prisma.WorkGroupFindFirstOrThrowArgs> = z.object({
...
export default WorkGroupFindFirstOrThrowArgsSchema;
