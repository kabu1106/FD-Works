...
export const SpecialLeaveTypeCreateArgsSchema: z.ZodType<Prisma.SpecialLeaveTypeCreateArgs> = z.object({
  select: SpecialLeaveTypeSelectSchema.optional(),
  include: z.lazy(() => SpecialLeaveTypeIncludeSchema).optional(),
  data: z.union([ SpecialLeaveTypeCreateInputSchema, SpecialLeaveTypeUncheckedCreateInputSchema ]),
}).strict();

export default SpecialLeaveTypeCreateArgsSchema;
