...
export const IncidentAllowanceSummaryFindUniqueArgsSchema: z.ZodType<Prisma.IncidentAllowanceSummaryFindUniqueArgs> = z.object({
...
export default IncidentAllowanceSummaryFindUniqueArgsSchema;
