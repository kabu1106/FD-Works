...
export const SpecialLeaveTypeFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.SpecialLeaveTypeFindUniqueOrThrowArgs> = z.object({
...
export default SpecialLeaveTypeFindUniqueOrThrowArgsSchema;
