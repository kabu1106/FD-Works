...
export const TeamUpdateWithoutWorkShiftInputSchema: z.ZodType<Prisma.TeamUpdateWithoutWorkShiftInput> = z.strictObject({
...
export default TeamUpdateWithoutWorkShiftInputSchema;
