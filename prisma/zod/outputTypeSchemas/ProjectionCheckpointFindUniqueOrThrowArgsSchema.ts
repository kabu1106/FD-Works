...
export const ProjectionCheckpointFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.ProjectionCheckpointFindUniqueOrThrowArgs> = z.object({
  select: ProjectionCheckpointSelectSchema.optional(),
  where: ProjectionCheckpointWhereUniqueInputSchema, 
}).strict();

export default ProjectionCheckpointFindUniqueOrThrowArgsSchema;
