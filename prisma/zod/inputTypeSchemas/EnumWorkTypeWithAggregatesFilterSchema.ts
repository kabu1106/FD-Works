...
import { NestedEnumWorkTypeWithAggregatesFilterSchema } from './NestedEnumWorkTypeWithAggregatesFilterSchema';
import { NestedIntFilterSchema } from './NestedIntFilterSchema';
import { NestedEnumWorkTypeFilterSchema } from './NestedEnumWorkTypeFilterSchema';

export const EnumWorkTypeWithAggregatesFilterSchema: z.ZodType<Prisma.EnumWorkTypeWithAggregatesFilter> = z.strictObject({
...
export default EnumWorkTypeWithAggregatesFilterSchema;
