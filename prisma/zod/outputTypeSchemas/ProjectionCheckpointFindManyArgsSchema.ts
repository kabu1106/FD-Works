...
export const ProjectionCheckpointFindManyArgsSchema: z.ZodType<Prisma.ProjectionCheckpointFindManyArgs> = z.object({
...
export default ProjectionCheckpointFindManyArgsSchema;
