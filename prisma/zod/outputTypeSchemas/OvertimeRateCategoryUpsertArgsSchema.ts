...
import { OvertimeRateCategoryCreateInputSchema } from '../inputTypeSchemas/OvertimeRateCategoryCreateInputSchema'
import { OvertimeRateCategoryUncheckedCreateInputSchema } from '../inputTypeSchemas/OvertimeRateCategoryUncheckedCreateInputSchema'
import { OvertimeRateCategoryUpdateInputSchema } from '../inputTypeSchemas/OvertimeRateCategoryUpdateInputSchema'
import { OvertimeRateCategoryUncheckedUpdateInputSchema } from '../inputTypeSchemas/OvertimeRateCategoryUncheckedUpdateInputSchema'
...
export const OvertimeRateCategoryUpsertArgsSchema: z.ZodType<Prisma.OvertimeRateCategoryUpsertArgs> = z.object({
  ...
  create: z.union([ OvertimeRateCategoryCreateInputSchema, OvertimeRateCategoryUncheckedCreateInputSchema ]),
  update: z.union([ OvertimeRateCategoryUpdateInputSchema, OvertimeRateCategoryUncheckedUpdateInputSchema ]),
}).strict();

export default OvertimeRateCategoryUpsertArgsSchema;
