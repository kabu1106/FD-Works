...
export const DispatchedVehicleFindManyArgsSchema: z.ZodType<Prisma.DispatchedVehicleFindManyArgs> = z.object({
...
export default DispatchedVehicleFindManyArgsSchema;
