...
export const OvertimeRateCategoryCreateArgsSchema: z.ZodType<Prisma.OvertimeRateCategoryCreateArgs> = z.object({
  select: OvertimeRateCategorySelectSchema.optional(),
  include: z.lazy(() => OvertimeRateCategoryIncludeSchema).optional(),
  data: z.union([ OvertimeRateCategoryCreateInputSchema, OvertimeRateCategoryUncheckedCreateInputSchema ]),
}).strict();

export default OvertimeRateCategoryCreateArgsSchema;
