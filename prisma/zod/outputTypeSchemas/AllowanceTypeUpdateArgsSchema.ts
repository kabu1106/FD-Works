...
export const AllowanceTypeUpdateArgsSchema: z.ZodType<Prisma.AllowanceTypeUpdateArgs> = z.object({
  select: AllowanceTypeSelectSchema.optional(),
  include: z.lazy(() => AllowanceTypeIncludeSchema).optional(),
  data: z.union([ AllowanceTypeUpdateInputSchema, AllowanceTypeUncheckedUpdateInputSchema ]),
  where: AllowanceTypeWhereUniqueInputSchema, 
}).strict();

export default AllowanceTypeUpdateArgsSchema;
