...
export const StaffCreateWithoutIncidentStaffEngagementsInputSchema: z.ZodType<Prisma.StaffCreateWithoutIncidentStaffEngagementsInput> = z.strictObject({
  staffNo: z.string(),
  name: z.string(),
...
export default StaffCreateWithoutIncidentStaffEngagementsInputSchema;
