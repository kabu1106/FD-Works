...
export const IncidentAllowanceSummaryFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.IncidentAllowanceSummaryFindUniqueOrThrowArgs> = z.object({
...
export default IncidentAllowanceSummaryFindUniqueOrThrowArgsSchema;
