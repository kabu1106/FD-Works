...
export const IncidentReadModelFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.IncidentReadModelFindUniqueOrThrowArgs> = z.object({
...
export default IncidentReadModelFindUniqueOrThrowArgsSchema;
