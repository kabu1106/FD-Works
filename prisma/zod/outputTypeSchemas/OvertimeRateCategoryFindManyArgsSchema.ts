...
export const OvertimeRateCategoryFindManyArgsSchema: z.ZodType<Prisma.OvertimeRateCategoryFindManyArgs> = z.object({
...
export default OvertimeRateCategoryFindManyArgsSchema;
