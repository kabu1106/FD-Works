...
export const DutyUncheckedUpdateWithoutAttendanceInputSchema: z.ZodType<Prisma.DutyUncheckedUpdateWithoutAttendanceInput> = z.strictObject({
...
export default DutyUncheckedUpdateWithoutAttendanceInputSchema;
