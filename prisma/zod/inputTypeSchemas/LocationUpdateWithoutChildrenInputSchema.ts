...
import { IncidentUpdateManyWithoutLocationNestedInputSchema } from './IncidentUpdateManyWithoutLocationNestedInputSchema';

export const LocationUpdateWithoutChildrenInputSchema: z.ZodType<Prisma.LocationUpdateWithoutChildrenInput> = z.strictObject({
  ...
  incidents: z.lazy(() => IncidentUpdateManyWithoutLocationNestedInputSchema).optional(),
});

export default LocationUpdateWithoutChildrenInputSchema;
