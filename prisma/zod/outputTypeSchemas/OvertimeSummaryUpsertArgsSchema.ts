...
import { OvertimeSummaryCreateInputSchema } from '../inputTypeSchemas/OvertimeSummaryCreateInputSchema'
import { OvertimeSummaryUncheckedCreateInputSchema } from '../inputTypeSchemas/OvertimeSummaryUncheckedCreateInputSchema'
import { OvertimeSummaryUpdateInputSchema } from '../inputTypeSchemas/OvertimeSummaryUpdateInputSchema'
import { OvertimeSummaryUncheckedUpdateInputSchema } from '../inputTypeSchemas/OvertimeSummaryUncheckedUpdateInputSchema'
...
export const OvertimeSummaryUpsertArgsSchema: z.ZodType<Prisma.OvertimeSummaryUpsertArgs> = z.object({
  ...
  create: z.union([ OvertimeSummaryCreateInputSchema, OvertimeSummaryUncheckedCreateInputSchema ]),
  update: z.union([ OvertimeSummaryUpdateInputSchema, OvertimeSummaryUncheckedUpdateInputSchema ]),
}).strict();

export default OvertimeSummaryUpsertArgsSchema;
