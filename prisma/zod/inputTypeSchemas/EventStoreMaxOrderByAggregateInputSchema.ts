...
export const EventStoreMaxOrderByAggregateInputSchema: z.ZodType<Prisma.EventStoreMaxOrderByAggregateInput> = z.strictObject({
...
export default EventStoreMaxOrderByAggregateInputSchema;
